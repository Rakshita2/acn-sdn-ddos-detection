...
class SimpleMonitor13(switch.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        model_path = "flow_model.joblib"
        if os.path.exists(model_path):
            self.logger.info("Loading trained model from file...")
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        file0.write('timestamp,datapath_id,flow_id,ip_src,tp_src,ip_dst,tp_dst,ip_proto,icmp_code,icmp_type,flow_duration_sec,flow_duration_nsec,idle_,hard_timeout,flags,packet_count,byte_count,packet_count_per_second,packet_count_per_nsecond,byte_count_per_second,byte_count_per_nsecond\n')
        body = ev.msg.body
        icmp_code = -1
        icmp_type = -1
        tp_src = 0
